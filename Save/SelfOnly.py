...
cl = SATAN2.LINE()
cl.login(token='EpCDlclspKvetR2qeyD4.vbU6UHxwJZPLiqAG3LO/La.Va4Y9oa0+SPoZ6EeWksfQCIEs1wW+4SM127mUTTQcoU=')
cl.loginResult()

ki1 = SATAN2.LINE()
ki1.login(token='Epd3EQTk4Z6Ur54OVTz5.Trbb5xpI9SaHEWMh3DRAjq.jlaAr0EFZOWSz70RX8LgSnZ76ZL9j/gae7DQyTGSyxk=')

ki2 = SATAN2.LINE()
ki2.login(token='EpdEO4f1yVLuDhyPqdId.F/CVmVWfcZnxJlQCR7VPNq.gBKXDyZPbsz1qi1Mv59viXxF9y9HKKBzbuhSicsvFB0=')
...
targets = []
mid = cl.getProfile().mid
Bots = ["u541bbaba15d68f3a652106a0de5a3e94",mid,Amid1,Amid2]
self = ["u541bbaba15d68f3a652106a0de5a3e94",mid,Amid1,Amid2]
