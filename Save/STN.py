...
cl = SATAN.LINE()
cl.login(token='EpTyUWz1P7iwsDRwuGa4.vbU6UHxwJZPLiqAG3LO/La.lx4KZuEVBqvNQRhcuqTKawb7cHfOGa+PHUQvxl9kUIo=')
cl.loginResult()

ki1 = SATAN.LINE()
ki1.login(token='EpnBrLUDdb8OXfRCSVg8.bkgPpxXPrPAZRLDEoxNDYa.Q9x5hjxNLHdor2RsEKoViIZ4cw0g2JtQqaFJhNHmxmk=')
ki1.loginResult()

ki2 = SATAN.LINE()
ki2.login(token='Ep3RzELR5naQfudU77V8.TTWtYUlQrcUxwXvRT+2Goa.4kXawMqbfgDpAG5t/zi10+FBLVtS0NoPtSb4rma06/g=')
ki2.loginResult()

ki3 = SATAN.LINE()
ki3.login(token='EpfD8paqxTVYp4wJXJdd.F/CVmVWfcZnxJlQCR7VPNq.EAxuNohI0LVb9TlwxMDtAPw8BrCca7JB1/F2pSVWqpk=')
ki3.loginResult()

ki4 = SATAN.LINE()
ki4.login(token='EpkY6wr20bENT8pWjRO5.Trbb5xpI9SaHEWMh3DRAjq.B1X69lrpxE+Y8TjUR1JjnIpIbQD4YOUCPMvorkwYhbY=')
ki4.loginResult()

ki5 = SATAN.LINE()
ki5.login(token='EpJhtDvITwP3MlDQBH41.rwuMFxBZUtI0U51sC+wC8q.0bDJBtYlpgAPqhvsNyTplOYSp5VJgV7NW3/fbShVUls=')
ki5.loginResult()

ki6 = SATAN.LINE()
ki6.login(token='EplRMBmFHE8Sp2mdF8Ia.KoXHmHiOzOkqtH1XV2hNkG.lGwKFgmCrcctUVSev4PXDafRze9J/5tIW0P+Bclt+DY=')
ki6.loginResult()

ki7 = SATAN.LINE()
ki7.login(token='EpuWj1dLDyXodCi0Dk35.P+TKw/uQ9eN6HLyqdtWbTq.LZcQTdNF2ckw9Uo+GgkCtmmfxVBKDlWeG8vKHt8qFLE=')
ki7.loginResult()
...
#=============================================
                ...
                kiki2 = random.choice(kiki) + " sᴇᴄᴏɴᴅs"
                cl.sendText(msg.to,kiki2)
                ki1.sendText(msg.to,kiki2)
                ki2.sendText(msg.to,kiki2)
                ki3.sendText(msg.to,kiki2)
                ki4.sendText(msg.to,kiki2)
                ki5.sendText(msg.to,kiki2)
                ki6.sendText(msg.to,kiki2)
                ki7.sendText(msg.to,kiki2)
