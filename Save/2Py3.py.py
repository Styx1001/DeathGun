...
cl = SATAN2.LINE()
cl.login(token='EpnIkJQ5qeEYLcWJpbd4.vbU6UHxwJZPLiqAG3LO/La.NRSaU/4G7n9g7eQ3dajYZFt6os677yMo273F0viVAUU=')
cl.loginResult()

ki1 = SATAN2.LINE()
ki1.login(token='Ep7pPHtjFkBUmSf5qNQd.F/CVmVWfcZnxJlQCR7VPNq.gtUM92I3FTtkxu6R9URnBKwOdABythlq5mdA9o8dLCQ=')

ki2 = SATAN2.LINE()
ki2.login(token='EpIjavtE4O5LGdoqcyj7.F8aFhi1/NE4zfJoLzJM+vW.ZiMde+FrkX1yQq6smjuRkmUgy6xhBbKJo5hiDYVCU/w=')

ki3 = SATAN2.LINE()
ki3.login(token='EpXhmpw1BhAb6QFjip41.rwuMFxBZUtI0U51sC+wC8q.IhUrZ+QFVWTLqAs+WAteXxDJEMK3Ss0mDcnyzNBT6dc=')
...
║☆͜͡➣ Show Comm
║❂ Hp2
║☆͜͡➣ Show Setting Comm
╚══════════════════
sᴇғᴛʙᴏᴛ ᴘʜᴇᴛ ʜᴀᴄᴋ ʙᴏᴛ
ᴅᴏɴ'ᴛ ᴛʜɪɴᴋ ᴡɪʟʟ ᴛʀʏ
ʙʏ ᴘʜᴇᴛ ʜᴀᴄᴋ ʙᴏᴛ
╔══════════════════
║ZssiK♥ line://ti/p/~esci_
╚══════════════════
"""
helpMessage1 ="""      ─┅═✥ ᴘʀᴇᴍɪᴜᴍ ✥═┅─
╔══════════════════
║ZssiK♥ ᴄᴏᴍᴍᴀɴᴅ ♥KissZ
╠══════════════════
║❂͜͡☆➣   Me
...
targets = []
mid = cl.getProfile().mid
Bots = ["u541bbaba15d68f3a652106a0de5a3e94",mid,Amid1,Amid2,Amid3]
self = ["u541bbaba15d68f3a652106a0de5a3e94",mid,Amid1,Amid2,Amid3]
...
#==================================================
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    ki.updateProfile(profile)
                        ...
                        ki1.sendText(msg.to,"[ ☢Ŧ€₳M≈ನန้ণএ≈฿❂Ŧ☢ ]")
                        ki2.sendText(msg.to,"ʜᴇʟʟᴏ " + str(ginfo.name) + "\n\n[ ʙʏ.เพชร ทีมทดลองบอท ]")
                        G = cl.getGroup(msg.to)
                        ginfo = cl.getGroup(msg.to)
                        G.preventJoinByTicket = True
                        ki1.updateGroup(G)
