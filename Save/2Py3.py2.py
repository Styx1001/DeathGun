...
cl = SATAN2.LINE()
cl.login(token='Epn8SyguAegzBQ08Hh24.vbU6UHxwJZPLiqAG3LO/La.USF8RGfLDlZLRmropsYZ6qUT8ot5yA+9jt35cVvfaTE=')
cl.loginResult()

ki1 = SATAN2.LINE()
ki1.login(token='EpInDJAB3EtuUJgFOhhd.F/CVmVWfcZnxJlQCR7VPNq.EoO7piOHZq+SXIajtQxItylsHq9H6WCPeeJJT5fdXMU=')

ki2 = SATAN2.LINE()
ki2.login(token='Ep5ojkX1tPkIAWp80Ja7.F8aFhi1/NE4zfJoLzJM+vW.Etv9FFD+XLkflIUxFKqn18LDjhvLdBb8rPpqsshMUEE=')
