...
targets = []
mid = cl.getProfile().mid
Bots = ["u541bbaba15d68f3a652106a0de5a3e94",mid]
self = ["u541bbaba15d68f3a652106a0de5a3e94",mid]
admin = "ua82c5e44b5dec4323334d2b6d40d5b57"
lower = "ua82c5e44b5dec4323334d2b6d40d5b57"
admsa = "ua82c5e44b5dec4323334d2b6d40d5b57"
adminMID = "ua82c5e44b5dec4323334d2b6d40d5b57"
...
#===========================================
        ...
        if op.type == 26:
            ...
            if msg.text in ["Banlist","Mcheck"]:
                if wait["blacklist"] == {}:
                    cl.sendText(msg.to,"ไม่มีผู้ใช้ที่อยู้ในบัญชีดำ  􀨁􀄻double thumbs up􏿿")
                else:
                    mc = "[⎈]  Blacklist  [⎈]\n"
...
#==============================================================================#
                ...
                if wait["blacklist"] == {}:
                    cl.sendText(msg.to,"ไม่มีผู้ใช้ที่อยู่ในบัญชีดำ")
                else:
                    cl.sendText(msg.to,"")
                    num=1
                    msgs="══════════List Blacklist═════════"
